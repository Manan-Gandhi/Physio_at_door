    ...
    <div class="main-wrapper">
        <div class="header">
			<div class="header-left">
				<a href="#" class="logo">
					<img src="assets/img/logo1.png" width="130" height="50" alt=""> 
				</a>
			</div>
            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="user-link" data-toggle="dropdown">
						...
						<a class="text-dark" href="index.php">Logout</a>
                    </a>
		        </li>
            </ul>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="viewPatient.php"><i class="fa fa-user"></i><span>View Patient </span><!-- <span class="menu-arrow"> --></a>
                            <!-- <ul style="display: none;">
                        ...
                        <li>
                            <a href="viewPhysio.php"><i class="fa fa-user-md"></i> <span>View Physiotherapist </span><!-- <span class="menu-arrow"> --></a>
                            <!-- <ul style="display: none;">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="viewComplaint.php"><i class="fa fa-comments-o"></i><span>View Complaint </span><!-- <span class="menu-arrow"> --></a>
                           <!--  <ul style="display: none;">
