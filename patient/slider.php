            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="content style text-center">
                        <h2 class="text-white text-bold mb-2">Our Best Physiotherapists</h2><br>
                        <a href="physiolist.php" class="btn btn-main btn-white">Show now</a>
                    </div>
                    <!-- Slide Content End -->
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="content style text-right">
                        <h2 class="text-white">We Care About <br>Your Health</h2><br>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="content text-center style">
                        <h2 class="text-white text-bold mb-2">Best Treatments</h2><br>
                       
                        <a href="service.php" class="btn btn-main btn-white">show now</a>
                    </div>
                    <!-- Slide Content End -->
                </div>
            </div>
